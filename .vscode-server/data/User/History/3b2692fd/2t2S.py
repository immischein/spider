...
class Spider:
    ...
    def face_up(self, speed = .5):
        self.move_single_leg([self.leg_1[0], 150, self.leg_1[2]], 0)
        arachnokiller.move_single_leg([60,0,30],5)
        arachnokiller.move_single_leg([120,0,30],0)

        arachnokiller.move_single_leg([60,90,60],2)
        arachnokiller.move_single_leg([120,60,60],4)

        arachnokiller.move_single_leg([60,60,60],1)
        arachnokiller.move_single_leg([120,60,60],4)
