    ...
    def tripod_turn(self, steps, direction, speed = 0.5):
        ...
        def sit_stand_steps_2(self, N=10, delay=.5, direction = 'up'):
            if direction == 'up':
                ...
                changing_deg2_2 = abs(self.deg2 - self.leg_1[2][1])
                changing_deg3_2 = abs(self.deg3 - self.leg_1[2][2])
                changing_deg2_3 = abs(self.deg2 - self.leg_1[2][1])
                changing_deg3_3 = abs(self.deg3 - self.leg_1[2][2])
                changing_deg2_4 = abs(self.deg2 - self.leg_1[2][1])
                changing_deg3_4 = abs(self.deg3 - self.leg_1[2][2])

                changing_deg2_5 = abs(self.deg2 - self.leg_1[2][1])
                changing_deg3_5 = abs(self.deg3 - self.leg_1[2][2])
                changing_deg2_6 = abs(self.deg2 - self.leg_1[2][1])
                changing_deg3_6 = abs(self.deg3 - self.leg_1[2][2])
