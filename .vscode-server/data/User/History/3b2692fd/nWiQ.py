...
class Spider:
    ...
    def change_single(self, index_leg, change_deg):
        ...
        sleep(.1)
        self.move_single_leg([current_deg[0] + change_deg, self.deg2, self.deg3], index_leg)
        ...
        if go:
            ...
            # Lift and move legs 0,1, 2 3, 4, 5 forward
                for leg_index in [[0, 2, 4], [1, 3, 5]]:
                    ...
                    sleep(.1)
                    self.move_single_leg([current_deg_1[0] + angle, self.deg2, self.deg3], leg_index[0])
                    self.move_single_leg([current_deg_2[0] + angle, self.deg2, self.deg3], leg_index[1])
                    self.move_single_leg([current_deg_3[0] + angle, self.deg2, self.deg3], leg_index[2])
    ...
    def sit_stand_steps_2(self, N=10, delay=.5, change = 1):
        if change == -1:
            changing_deg2_1 = abs(self.deg2 - self.leg_1[2][1])
            changing_deg3_1 = abs(self.deg3 - self.leg_1[2][2])

            changing_deg2_2 = abs(self.deg2 - self.leg_2[2][1])
            changing_deg3_2 = abs(self.deg3 - self.leg_2[2][2])

            changing_deg2_3 = abs(self.deg2 - self.leg_3[2][1])
            changing_deg3_3 = abs(self.deg3 - self.leg_3[2][2])

            changing_deg2_4 = abs(self.deg2 - self.leg_4[2][1])
            changing_deg3_4 = abs(self.deg3 - self.leg_4[2][2])

            changing_deg2_5 = abs(self.deg2 - self.leg_5[2][1])
            changing_deg3_5 = abs(self.deg3 - self.leg_5[2][2])

            changing_deg2_6 = abs(self.deg2 - self.leg_6[2][1])
            changing_deg3_6 = abs(self.deg3 - self.leg_6[2][2])

            deg_stand_steps_2_1 = changing_deg2_1/N*change
            deg_stand_steps_3_1 = changing_deg3_1/N*change

            deg_stand_steps_2_2 = changing_deg2_2/N*change
            deg_stand_steps_2_2 = changing_deg3_2/N*change

            deg_stand_steps_2_3 = changing_deg2_3/N*change
            deg_stand_steps_3_3 = changing_deg3_3/N*change

            deg_stand_steps_2_4 = changing_deg2_4/N*change
            deg_stand_steps_3_4 = changing_deg3_4/N*change

            deg_stand_steps_2_5 = changing_deg2_5/N*change
            deg_stand_steps_3_5 = changing_deg3_5/N*change

            deg_stand_steps_2_6 = changing_deg2_6/N*change
            deg_stand_steps_3_6 = changing_deg3_6/N*change

        elif change == 1:
            changing_deg2_1 = abs(175 - self.leg_1[2][1])
            changing_deg3_1 = abs(162 - self.leg_1[2][2])
            deg_stand_steps_2_1 = changing_deg2_1/N*change
            deg_stand_steps_3_1 = changing_deg3_1/N*change

            changing_deg2_2 = abs(175 - self.leg_2[2][1])
            changing_deg3_2 = abs(162 - self.leg_2[2][2])
            deg_stand_steps_2_2 = changing_deg2_2/N*change
            deg_stand_steps_3_2 = changing_deg3_2/N*change

            changing_deg2_3 = abs(175 - self.leg_3[2][1])
            changing_deg3_3 = abs(162 - self.leg_3[2][2])
            deg_stand_steps_2_3 = changing_deg2_3/N*change
            deg_stand_steps_3_3 = changing_deg3_3/N*change

            changing_deg2_4 = abs(175 - self.leg_4[2][1])
            changing_deg3_4 = abs(162 - self.leg_4[2][2])
            deg_stand_steps_2_4 = changing_deg2_4/N*change
            deg_stand_steps_3_4 = changing_deg3_4/N*change

            changing_deg2_5 = abs(175 - self.leg_5[2][1])
            changing_deg3_5 = abs(162 - self.leg_5[2][2])
            deg_stand_steps_2_5 = changing_deg2_5/N*change
            deg_stand_steps_3_5 = changing_deg3_5/N*change

            changing_deg2_6 = abs(175 - self.leg_6[2][1])
            changing_deg3_6 = abs(162 - self.leg_6[2][2])
            deg_stand_steps_2_6 = changing_deg2_6/N*change
            deg_stand_steps_3_6 = changing_deg3_6/N*change
        else:
            print('no correct direction given')
