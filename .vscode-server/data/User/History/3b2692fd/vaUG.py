...
class Spider:
    ...
    def sitdown(self):
        self.move_single_leg([self.leg_1[2][0],90,180], 0)
        self.move_single_leg([self.leg_3[2][0],90,180], 2)
        self.move_single_leg([self.leg_4[2][0],90,180], 3)
        self.move_single_leg([self.leg_6[2][0],90,180], 5)
        self.move_single_leg([self.leg_1[2][0],90,180], 1)
        self.move_single_leg([self.leg_3[2][0],90,180], 4)

        self.move_single_leg([self.leg_1[2][0],90,150], 0)
        self.move_single_leg([self.leg_3[2][0],90,150], 2)
        self.move_single_leg([self.leg_4[2][0],90,150], 3)
        self.move_single_leg([self.leg_6[2][0],90,150], 5)
        self.move_single_leg([self.leg_1[2][0],90,150], 1)
        self.move_single_leg([self.leg_3[2][0],90,150], 4)

        self.move_single_leg([self.leg_1[2][0],90,120], 0)
        self.move_single_leg([self.leg_3[2][0],90,120], 2)
        self.move_single_leg([self.leg_4[2][0],90,120], 3)
        self.move_single_leg([self.leg_6[2][0],90,120], 5)
        self.move_single_leg([self.leg_1[2][0],90,120], 1)
        self.move_single_leg([self.leg_3[2][0],90,120], 4)
